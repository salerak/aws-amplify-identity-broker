...
export const i18nStrings = {
	...
	[Translations.EMAIL_PLACEHOLDER]: "española.email@ejemplo.com",
	...
	"Custom auth lambda trigger is not configured for the user pool.": "El disparador lambda de autenticación personalizado no está configurado para el grupo de usuarios.",
	// ### This may change in the future: see https://github.com/aws-amplify/amplify-js/issues/6898
	"1 validation error detected: Value at 'password' failed to satisfy constraint: Member must have length greater than or equal to 6": "1 error de validación detectado: el valor en 'contraseña' no pudo satisfacer la restricción: el miembro debe tener una longitud mayor o igual a 6.",
	...
	TERMS_OF_SERVICE_CONTENT_TITLE: "Términos de servicio",
	TERMS_OF_SERVICE_CONTENT_P1: "1. Regulaciones generales",
	TERMS_OF_SERVICE_CONTENT_P2: "2. Servicios de la plataforma",
	TERMS_OF_SERVICE_CONTENT_LOREM_IPSUM: "ES - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud ejercicio ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint Ocecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
	TERMS_OF_SERVICE_CONTENT_BUTTON_ACCEPT_LABEL: "Aceptar",
	TERMS_OF_SERVICE_CONTENT_BUTTON_DECLINE_LABEL: "Disminución",

	// ./pages/xxx/xxx.js
	IMPRINT_TITLE: "Imprint",

	// ./components/AppBar/AppBar.js
	HEADER_MENU_ITEM_PROFILE: "Perfil",
	HEADER_MENU_ITEM_DASHBOARD: "Tablero",
	HEADER_MENU_ITEM_LOGOUT: "Cerrar sesión",

	// ./components/ChangePasswordDialog/ChangePasswordDialog.js
	CHANGE_PASSWORD_TITLE: "Cambiar la contraseña",
	CHANGE_PASSWORD_DESCRIPTION: "Ingrese su contraseña actual y nueva",
